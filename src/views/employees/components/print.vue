  ...
  <div id="myPrint" class="dashboard-container">
    <div class="app-container">
      <el-card>
        ...
        <el-button
          v-print="`${type === 'personal' ? '#printPeronalRange' : '#jobInfoRange'}`"
          size="mini"
          type="primary"
        ...
        <!-- 通过type判断，如果是 personal 字符串的话，显示个人信息页面 -->
        <div v-if="type === 'personal'" id="printPeronalRange">
...
// 参数问题：动态传入参数：id 路径上要通过 ?type

// 访问的时候，应该用这个地址：/print/123?type=personal
