...
import HireTypeEnum from '@/api/constant/employees'
...
// 格式化聘用形式
export function formatterHire(type) {
  const hire = HireTypeEnum.hireType.find(item => item.id === +type)
...
// 之前的形式，只能像这样一个个的去取
// import { formatterHire } from './filter/index.js'

// 能否一次性把这里所有的暴露的属性都放一块呢？
// import * as filters from './filter/index.js'

// 可以通过 filter.formatterHire 这个方法
